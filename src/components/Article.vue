<template>
    <div :class="{ 'grid sm:grid-cols-5 gap-4 sm:gap-12': isList }">
        <div
            class="h-64"
            :class="{
        ...
        <div class="mt-1 sm:col-span-2 flex flex-col justify-between">
            ...
            >
                ...
                <h3 class="mt-1 leading-tight text-2xl">
                    <router-link :to="`/articles/${article.slug}`" class="hover:text-primary font-bold transition-colors duration-300">{{ article.title }}</router-link>
                </h3>
