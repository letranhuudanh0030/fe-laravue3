<template>
    <InnerPageHero :image-url="article.image_url" :title="article.title" height="articleDetail" />
...
export default {
    ...
    setup(props) {
        let { articleDetail, articleDetailLoading, fetchArticleDetails } = useArticle()
