<template>
    <InnerPageHero image-url="/images/image-4.jpg" title="Articles" />
    ...
    <div class="container mx-auto px-4 sm:px-0 py-8 sm:py-20">
        ...
        <div class="mt-8 sm:mt-12">
            <button class="px-4 py-2 sm:px-6 bg-primary text-white rounded focus:outline-none" @click="showMoreArticles" v-if="articles.links.next !== null">
